...
class QuestionForm(forms.ModelForm):
    ...
    description = forms.CharField(widget=forms.Textarea(attrs={'class':'form-control'}), 
        max_length=2000)
    urls = forms.CharField(widget=forms.TextInput(attrs={'class':'form-control'}),
        max_length=255,
        required=False,
        help_text='Use spaces to separate the urls, such as "asp.net mvc5 javascript"')

    class Meta:
        model = Question
        fields = ['title', 'description', 'urls']
